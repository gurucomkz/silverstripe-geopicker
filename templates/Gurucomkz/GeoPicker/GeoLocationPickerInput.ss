<% if $ApiKey %>
    ...
    <div id="Map_Wrapper_$ID" style="width:100%; height:400px;position:relative;border:1px solid black;">
        ...
        <div style="width:1px; height:50%; left:50%;top: 25%;z-index:1000;background:black;position:absolute;pointer-events:none;"></div>
        <div style="height:1px; width:50%; top:50%;left: 25%;z-index:1000;background:black;position:absolute;pointer-events:none;"></div>
